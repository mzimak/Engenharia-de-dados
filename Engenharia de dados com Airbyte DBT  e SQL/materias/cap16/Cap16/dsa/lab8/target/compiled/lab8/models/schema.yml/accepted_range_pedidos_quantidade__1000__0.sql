...
WITH validation AS (
    SELECT
        quantidade AS value             -- Seleciona os valores da coluna especificada
    FROM main."pedidos"                           -- Seleciona a partir do modelo/tabela especificado
    WHERE quantidade < 0  -- Condição: seleciona valores menores que o valor mínimo
       OR quantidade > 1000  -- Condição: seleciona valores maiores que o valor máximo
)
